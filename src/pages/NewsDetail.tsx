...
const NewsDetail = () => {
  ...
  const isRedirecting = useSlugRedirect(slug, "news");
        ...
        <div className="container mx-auto px-4">
          <article className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-6">
              <span className="px-3 py-1 rounded-lg bg-red-500/10 text-red-500 text-sm font-medium">
                أخبار
              </span>
            ...
            {newsItem.cover_url && (
              <div className="relative w-full rounded-2xl overflow-hidden mb-8">
                <img
                  ...
                  alt={newsItem.alt_text || newsItem.title}
                  loading="eager"
          ...
          {/* إضافة قسم التعليقات */}
          {newsItem && <CommentsSection newsId={newsItem.id} />}
        </div>
      </main>
