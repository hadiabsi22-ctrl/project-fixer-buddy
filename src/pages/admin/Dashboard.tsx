...
import { FileText, Lightbulb, Plus, Eye, Image as ImageIcon } from "lucide-react";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import AdminLayout from "@/components/admin/AdminLayout";
import { supabase } from "@/integrations/supabase/client";
import { useImageStorageUsage } from "@/hooks/useImageStorageUsage";
...
const Dashboard = () => {
  const { totalMB, isLoading: isStorageLoading } = useImageStorageUsage();
  ...
  const statCards = [
    ...
    {
      title: "إجمالي حجم الصور (Storage)",
      value: `${isStorageLoading ? "..." : totalMB.toFixed(2)} MB`,
      icon: ImageIcon,
      color: "text-blue-400",
